...
//PHH Schema Manhattan
const manhattanPHHSchema = mongoose.Schema(
    {
        "Unique Key": Number,
        "Created Date": String,
        "Closed Date": String,
    ...
    {
        collection: "Manhattan_311PestsHeatHotWater",
    }
);

module.exports = mongoose.model("manhattanPHHData", manhattanPHHSchema);